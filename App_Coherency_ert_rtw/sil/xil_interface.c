 ...
 *
 * SIL generated interface for code: "App_Coherency"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtU.App_vSensor1);
        ...
        {
          void * dataAddress = (void *) &(rtU.App_vSensor1_a);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtY.App_bSensor1Failure);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY.App_bSensor2Failure);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY.App_bCoherencyFailure);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
